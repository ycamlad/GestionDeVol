...
${OBJECTDIR}/Aeroport.o: Aeroport.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Aeroport.o Aeroport.cpp

${OBJECTDIR}/Arrivee.o: Arrivee.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arrivee.o Arrivee.cpp
...
${OBJECTDIR}/Vol.o: Vol.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Vol.o Vol.cpp
...
${TESTDIR}/AeroportTesteur.o: AeroportTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/AeroportTesteur.o AeroportTesteur.cpp


${TESTDIR}/ArriveeTesteur.o: ArriveeTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/ArriveeTesteur.o ArriveeTesteur.cpp


${TESTDIR}/DepartTesteur.o: DepartTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/DepartTesteur.o DepartTesteur.cpp


${TESTDIR}/VolTesteur.o: VolTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/VolTesteur.o VolTesteur.cpp
...
${OBJECTDIR}/Aeroport_nomain.o: ${OBJECTDIR}/Aeroport.o Aeroport.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Aeroport_nomain.o Aeroport.cpp;\
	else  \
...
${OBJECTDIR}/Arrivee_nomain.o: ${OBJECTDIR}/Arrivee.o Arrivee.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arrivee_nomain.o Arrivee.cpp;\
	else  \
...
${OBJECTDIR}/Vol_nomain.o: ${OBJECTDIR}/Vol.o Vol.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Vol_nomain.o Vol.cpp;\
	else  \
